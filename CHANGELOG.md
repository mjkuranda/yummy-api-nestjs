...
- [Marek Kurańda](https://github.com/mjkuranda): Dish new controllers.
- [Marek Kurańda](https://github.com/mjkuranda): New decorator - `@User`.
- [Marek Kurańda](https://github.com/mjkuranda): Errors for `Recipe` module.
...
## [3.1.2] - 2025-05-02
### Changed
- [Marek Kurańda](https://github.com/mjkuranda): Message for invalid data within `DishDTO`.

## [3.1.1] - 2025-05-02
### Added
- [Marek Kurańda](https://github.com/mjkuranda): `NotificationService` to inform about memory usage.

### Fixed
- [Marek Kurańda](https://github.com/mjkuranda): Out of memory error on the production.
- [Marek Kurańda](https://github.com/mjkuranda): Bumped `@nestjs/common@10.4.17`, `axios@1.9.0` and `mongoose@7.8.7` packages.
...
## [2.13.0] - 2025-02-24
### Added
- [Marek Kurańda](https://github.com/mjkuranda): `GET /healthcheck` endpoint for checking API activity.

## [2.12.0] - 2025-02-22
### Added
- [Marek Kurańda](https://github.com/mjkuranda): `CorsInterceptor` to block requests from another source.

## [2.11.0] - 2025-01-31
### Added
- [Marek Kurańda](https://github.com/mjkuranda): `GET /users/:login/profile` endpoint for getting basic information about provided `:login` profile.
- [Marek Kurańda](https://github.com/mjkuranda): `MongoIdValidationPipe` for validating MongoDB ObjectIds.
