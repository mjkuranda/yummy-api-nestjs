...
@Injectable()
export class GetDishesWithSoftAddedUseCase extends AbstractUseCase<[], GetDishesDto> {
    ...
    protected async run(): Promise<GetDishesDto> {
        const dishes = await this.dishReadService.getDishesWithSoftAdded();
    ...
    protected get context(): ContextString {
        return 'GetDishesWithSoftAddedUseCase/run';
    }
}