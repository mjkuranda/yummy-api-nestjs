...
export const providerServices: Provider[] = [
    ...
    {
        provide: Repository.DISH_REPOSITORY,
        useClass: MongodbDishRepository
    },
    {
        provide: Repository.RECIPE_REPOSITORY,
        useClass: MongodbRecipeRepository
    },
    ...
    SpoonacularApiService,
    {
        provide: PROVIDERS,
        useFactory: (
            dishMatcherApiService: Providable,
            spoonacularApiService: Providable
        ): ProviderMap => ({
